...
export default function Page() {
	return (
		<main>
			<div className='max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 border-t border-zinc-200'>
				<div className='py-24 px-8 bg-zinc-50 border-b lg:border-r lg:border-b-0 border-zinc-200'>
					...
					<p className='leading-8 text-lg mt-6 text-zinc-600'>
						...
						back to you as soon as possible. Be sure to leave a valid email and
