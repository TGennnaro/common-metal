	...
	return (
		<main>
			...
			<section className='px-8 py-16 columns-3 gap-x-8 [&>p]:indent-8 [&>p]:text-justify leading-relaxed'>
				...
				<p>
					Welcome to Commonwealth Metal Company, a leading force in the world of
					welding and fabrication. Founded and led by Suzzane Stilwell, a
					...
					metal solutions since 1988. With an extensive background in the field,
					Ms. Stilwell&apos;s journey began by working in major metal warehouses
					and serving as a purchasing agent, which provided her with invaluable
				...
				<p>
					...
					of Women Business Owners and the Greater Philadelphia Chamber of
					Commerce.
				</p>
				<p>
					Our founder, Ms. Stilwell, embodies the spirit of excellence, which
					has earned her recognition as one of the area&apos;s Top Twenty Women
					in non-traditional businesses and accolades from various quarters. We
					believe in the power of building strong relationships, and that&apos;s
					why we actively participate in seminars and workshops to connect with
					like-minded businesses and potential partners. At Commonwealth Metal,
					we operate with the core principle that treating customers with
					respect and product knowledge forms the foundation of success. While
					being certified as a MBE or WBE is vital, we understand that growth
					stems from a deep understanding of our products, industry, and the
					cultivation of lasting customer relationships. Join us as we continue
					to forge new pathways in the metal industry, delivering quality,
					reliability, and innovation to every project we touch.
				</p>
			</section>
		</main>
	);
